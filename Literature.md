...
| **Gow et al., 2017** (*PLOS ONE*) | A landmark study that calculated **maximum Lyapunov exponents from trunk accelerometers** to assess the long-term and short-term effects of Tai Chi training on fractal stride time dynamics. This is a direct precedent for using LyE as an outcome measure for Tai Chi interventions. |
